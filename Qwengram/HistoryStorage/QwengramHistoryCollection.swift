...
public enum QwengramHistoryCollection {
    // Qwengram-local reservation: application-specific ordered collection 1000 + 9.
...
public struct QwengramHistoryMessageKey: Codable, Equatable {
